...
static int is_eol_crlf(xdfile_t *file, int i)
{
	...
	if (i < (long)file->record.length - 1)
...
{
	for (; chg; chg--, i++)
		if (line_contains_alnum((const char *)xe->xdf2.record.ptr[i].ptr,
				(long)xe->xdf2.record.ptr[i].size))
			return 1;
	return 0;
}
		...
		xmparam_t const *xmp, mmbuffer_t *result)
{
	...
	while (xscr1) {
		...
		i0 = xscr1->i1;
		i1 = xscr1->i2;
		i2 = xscr1->i1 + (long)xe2->xdf2.record.length - (long)xe2->xdf1.record.length;
		chg0 = xscr1->chg1;
		chg1 = xscr1->chg2;
		chg2 = xscr1->chg1;
		if (xdl_append_merge(&c, 1,
	...
	while (xscr2) {
		if (!changes)
			changes = c;
		i0 = xscr2->i1;
		i1 = xscr2->i1 + (long)xe1->xdf2.record.length - (long)xe1->xdf1.record.length;
		i2 = xscr2->i2;
		chg0 = xscr2->chg1;
		chg1 = xscr2->chg1;
		chg2 = xscr2->chg2;
